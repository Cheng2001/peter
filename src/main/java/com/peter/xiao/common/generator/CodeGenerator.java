...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //连接数据库 URL
        dsc.setUrl("jdbc:mysql://cdb-lx88tlpe.bj.tencentcdb.com:10264/peter?useUnicode=true&useSSL=false&characterEncoding=utf8");
